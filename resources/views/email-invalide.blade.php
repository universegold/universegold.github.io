         ...
         <div class="row">
               <div class="col-xl-9 mx-auto">
                   <div class="cta-inner bg-faded text-center rounded">
                       ...
                       <h3><font color="brown">    تعديل البيانات 
                        </font></h3>
                        <br>
              <div class="card-body">
                        ...
                        <div class="col-md-6">
                                ...
                                class="form-control @error('email') is-invalid @enderror" name="email" value=""
                                 required autocomplete="email">
                                   <font color="red">قد تم استخدام هذا البريد الإلكتروني</font>
                   ...
                   <h6> <a href="../modif-pass/{{$user['id']}}" class="text-primary underline">تعديل كلمة المرور</a></h6>
